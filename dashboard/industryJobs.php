    ...
    <div class="row"> 
            ...
            <div class="dashboard-box margin-top-0"> 
              ...
              <div class="content">
                ...
                <?php 
                  ...
                  $query = "SELECT * FROM job_post WHERE industry_id = '$career_id[0]' ORDER BY id_jobpost DESC";  
                  ...
                  $sql =  "SELECT * FROM job_post WHERE industry_id = '$career_id[0]' ORDER BY id_jobpost DESC LIMIT " . $page_first_result . ',' . $results_per_page;
                  $query = $conn->query($sql);
                  while($row = $query->fetch_assoc()){
                    $id_jobpost = $row['id_jobpost'];
                    $job = $conn->query("SELECT jobtitle, job_status, city_id, industry_id, minimumsalary, maximumsalary, createdat, id_company FROM job_post WHERE id_jobpost = '$id_jobpost'");
                    $job = $job->fetch_row();
                        ...
                        <div class="utf-job-listing-description">
                          ...
                          <div class="utf-job-listing-footer">
                            ...
                            <div class="utf-buttons-to-right"> 
                              ...
                              <?php else: ?>
                              <a href="#" class="button yellow ripple-effect ico apply" data-id="<?php echo $id_jobpost ?>" onclick="return confirm('Do you want to apply for this job?')" title="Apply" data-tippy-placement="top"><i class="icon-feather-edit"></i></a>
                              <?php endif; ?>
      ...
      <div class="utf-pagination-container-aera margin-top-20 margin-bottom-0">
        <nav class="pagination">
          ...
          <li><a href="industryJobs.php?page=<?php echo $page ?>" class="ripple-effect"><?php echo $page ?></a></li>
          <?php }  ?>
