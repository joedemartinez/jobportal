    ...
    <div class="row"> 
            ...
            <div class="dashboard-box margin-top-0"> 
              ...
              <div class="content">
                ...
                <?php 
                  ...
                  $query = "SELECT * FROM job_post WHERE id_company = '$id_company' ORDER BY id_jobpost DESC";  
                  ...
                  $sql =  "SELECT * FROM job_post WHERE id_company = '$id_company' ORDER BY id_jobpost DESC LIMIT " . $page_first_result . ',' . $results_per_page;
                  $query = $conn->query($sql);
                  while($row = $query->fetch_assoc()){
                    $id_jobpost = $row['id_jobpost'];
                    $city_id = $row['city_id'];
                    $industry = $row['industry_id'];
                    $jobtype = $row['job_status'];
                    ...
                    <div class="utf-job-listing">                       
                      <div class="utf-job-listing-details"> 
                        ...
                        <div class="utf-job-listing-description">
                          ...
                          <h3 class="utf-job-listing-title"><a href="#"><?php echo $row['jobtitle'] ?></a><span class="dashboard-status-button green"><i class="icon-material-outline-business-center"></i> <?php echo $jobtype[0] ?></span></h3>                          
                          <div class="utf-job-listing-footer">
                            <ul>
                              <li><i class="icon-feather-briefcase"></i> <?php echo $category[0] ?></li>
                              <li><i class="icon-material-outline-date-range"></i> <?php echo $row['createdat'] ?></li>
                              <li><i class="icon-material-outline-money"></i> GH₵<?php echo $row['minimumsalary'].' - GH₵'.$row['maximumsalary'] ?></li>
                            ...
                            <div class="utf-buttons-to-right"> 
                              ...
                              <a href="#" class="button red ripple-effect ico delete" data-id="<?php echo $id_jobpost ?>" onclick="return confirm('Do you want to delete this job post?')" title="Remove" data-tippy-placement="top"><i class="icon-feather-trash-2"></i></a> 
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div class="utf-pagination-container-aera margin-top-20 margin-bottom-0">
        <nav class="pagination">
          ...
          <li><a href="manageJobs.php?page=<?php echo $page ?>" class="ripple-effect"><?php echo $page ?></a></li>
          <?php }  ?>
