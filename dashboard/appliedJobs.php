    ...
    <div class="row"> 
            ...
            <div class="dashboard-box margin-top-0"> 
              ...
              <div class="content">
                ...
                <?php 
                  ...
                  $query = "SELECT * FROM applied_jobposts WHERE id_user = '$id_user' ORDER BY id_applied DESC";  
                  ...
                  $sql =  "SELECT * FROM applied_jobposts WHERE id_user = '$id_user' ORDER BY id_applied DESC LIMIT " . $page_first_result . ',' . $results_per_page;
      ...
      <div class="utf-pagination-container-aera margin-top-20 margin-bottom-0">
        <nav class="pagination">
          ...
          <li><a href="appliedJobs.php?page=<?php echo $page ?>" class="ripple-effect"><?php echo $page ?></a></li>
          <?php }  ?>
